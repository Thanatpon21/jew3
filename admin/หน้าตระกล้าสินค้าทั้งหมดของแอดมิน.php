  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 a href="insert.php" class="fw-light">ตะกร้าสินค้าทั้งหมด</h1>
        <p>
  <div class="col-md-4">
       <button id="Submit"  name="Submit" class="btn btn-primary" <a href="การเพิ่ม.php"> เพิ่มสินค้า </a></button>
       <button id="Submit"  name="Submit" class="btn btn-primary" <a href="การเพิ่ม.php"> ลบสินค้า </a></button>
  </div>         
